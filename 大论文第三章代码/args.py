...
def _add_common_args(arg_parser):
   ...
   Evaluation
    arg_parser.add_argument('--device_id', type=str, default="1", help="gpu device id")
...
def train_argparser():
   ...
   Logging
    ...
    arg_parser.add_argument('--retrieval_file', help='The retrieved contexts from the knowledge base.')
    arg_parser.add_argument('--conll_folder',
    ...
    arg_parser.add_argument('--use_sentence', action='store_true',
                            help='use  matched sentence in the retrieval results as the contexts')
    arg_parser.add_argument('--use_paragraph_entity', action='store_true',

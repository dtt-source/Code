...
from identifier.generate_data import main
from identifier.context_process import concate
...
class IdentifierTrainer(BaseTrainer):
    ...
    def train(self, train_path: str, valid_path: str, types_path: str, input_reader_cls: BaseInputReader):
       ...
       datasets
        ...
        updates_epoch = train_sample_count // args.train_batch_size #一个epoch里的batch数
        updates_total = updates_epoch * args.epochs #总batch数
       ...
       scheduler
       transformers.get_constant_schedule_with_warmup(optimizer,
       updates_total)
